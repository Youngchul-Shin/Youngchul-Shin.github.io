...
16. New mathematical formulation for idle OHT vehicle repositioning: maximization of repositioning success probability
<br>**Y. Shin**, Y. Jeong, and G. Kim*. (2025) [_Engineering Optimization_](https://www.tandfonline.com/journals/geno20), 1 – 26.
15. Robust closed-loop supply chain model with return management system for circular economy
...
14. Flexible material handling system for multi-load autonomous mobile robots in manufacturing environments: a hierarchical reinforcement learning approach
...
13. Uncertain demurrage and detention decisions in hinterland container management
...
12. Resilient shuttle vehicle plan under route disruption scenarios and ticketing policies: a case study of the Qiandaohu archipelago scenic area, China
<br>X. Feng, D. Li, **Y. Shin**, and Y. Zhou*. (2024) [_Current Issues in Tourism_](https://www.tandfonline.com/journals/rcit20), 1 – 20.
11. A hybrid deep reinforcement learning approach for a proactive transshipment of fresh food in the online–offline channel system
...
10. Multiple-objective scheduling for batch process systems using stochastic utility evaluation
...
9. Distributionally robust multiperiod inventory model for omnichannel retailing considering Buy-Online, Pickup-in-Store and Out-of-Stock, Home-Delivery services
...
8.  Robust building evacuation planning in a dynamic network flow model under collapsible nodes and arcs
...
7. Optimal start time of a markdown sale under a two‐echelon inventory system
...
6. Robust multiperiod inventory model with a new type of buy one get one promotion:“My Own Refrigerator”
<br>**Y. Shin**, S. Lee, and I.K. Moon*. (2021) [_Omega_](https://www.sciencedirect.com/journal/omega), 99, 102170.
5. Robust multiperiod inventory model considering trade-in program and refurbishment service: Implications to emerging markets
...
4. Simultaneous evacuation and entrance planning in complex building based on dynamic network flows
...
3. Integrated optimal scheduling of repair crew and relief vehicle after disaster
...
2. Network repair crew scheduling for short-term disasters
...
1. Early stage response problem for post-disaster incidents
